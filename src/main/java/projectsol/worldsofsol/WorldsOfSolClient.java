...
public class WorldsOfSolClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        RenderLayers.init();
        BlockRenderLayerMap.INSTANCE.putBlock(SolObjects.MOON_LEAVES, RenderLayer.getTranslucent());
        BlockRenderLayerMap.INSTANCE.putBlock(SolObjects.BULB_PEAKER, RenderLayer.getCutout());
