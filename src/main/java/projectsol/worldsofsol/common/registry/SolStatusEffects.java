...
import projectsol.worldsofsol.common.statuseffect.CosmicBreathingStatusEffect;
import projectsol.worldsofsol.common.statuseffect.RadiationStatusEffect;

import java.util.LinkedHashMap;
import java.util.Map;

public class SolStatusEffects {
    ...
    public static final Potion COSMIC_BREATHING_POTION = new Potion("cosmic_breathing", new StatusEffectInstance(SolStatusEffects.COSMIC_BREATHING, 18000));
    public static final Potion COSMIC_BREATHING_POTION_LONG = new Potion("long_cosmic_breathing", new StatusEffectInstance(SolStatusEffects.COSMIC_BREATHING, 31800));
